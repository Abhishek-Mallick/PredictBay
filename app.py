...
def news():
    ...
    if response.status_code == 200:
        ...
        # Find the elements that contain news headlines and descriptions
        # You may need to inspect the website's HTML structure to identify these elements
        headlines = soup.find_all('h2', class_='news-headline')
        descriptions = soup.find_all('p', class_='news-description')

        # Create a list to store news data
        news_data = []

        # Iterate through the headlines and descriptions and store them in a list
